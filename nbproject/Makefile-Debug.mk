...
${OBJECTDIR}/src/Adedigado.o: src/Adedigado.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Adedigado.o src/Adedigado.cpp

${OBJECTDIR}/src/Adresse.o: src/Adresse.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Adresse.o src/Adresse.cpp

${OBJECTDIR}/src/Atelier.o: src/Atelier.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Atelier.o src/Atelier.cpp

${OBJECTDIR}/src/C_BDD.o: src/C_BDD.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/C_BDD.o src/C_BDD.cpp

${OBJECTDIR}/src/C_Capteur.o: src/C_Capteur.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/C_Capteur.o src/C_Capteur.cpp

${OBJECTDIR}/src/C_Consignes.o: src/C_Consignes.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/C_Consignes.o src/C_Consignes.cpp

${OBJECTDIR}/src/C_Informations.o: src/C_Informations.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/C_Informations.o src/C_Informations.cpp

${OBJECTDIR}/src/Capteur.o: src/Capteur.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Capteur.o src/Capteur.cpp

${OBJECTDIR}/src/Climat.o: src/Climat.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Climat.o src/Climat.cpp

${OBJECTDIR}/src/Consignes.o: src/Consignes.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Consignes.o src/Consignes.cpp

${OBJECTDIR}/src/Incident.o: src/Incident.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Incident.o src/Incident.cpp

${OBJECTDIR}/src/Information.o: src/Information.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Information.o src/Information.cpp

${OBJECTDIR}/src/NatureInfo.o: src/NatureInfo.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/NatureInfo.o src/NatureInfo.cpp

${OBJECTDIR}/src/ProtocoleCapteurs.o: src/ProtocoleCapteurs.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ProtocoleCapteurs.o src/ProtocoleCapteurs.cpp

${OBJECTDIR}/src/TClimat.o: src/TClimat.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TClimat.o src/TClimat.cpp

${OBJECTDIR}/src/TestIntegration.o: src/TestIntegration.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TestIntegration.o src/TestIntegration.cpp

${OBJECTDIR}/src/Unite.o: src/Unite.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Unite.o src/Unite.cpp
...
${OBJECTDIR}/src/test.o: src/test.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/test.o src/test.cpp

${OBJECTDIR}/src/testIntegrationCapteurClimat.o: src/testIntegrationCapteurClimat.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/testIntegrationCapteurClimat.o src/testIntegrationCapteurClimat.cpp

${OBJECTDIR}/src/testIntegrationCapteurs.o: src/testIntegrationCapteurs.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/testIntegrationCapteurs.o src/testIntegrationCapteurs.cpp

${OBJECTDIR}/src/testIntegrationClimat.o: src/testIntegrationClimat.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/testIntegrationClimat.o src/testIntegrationClimat.cpp

${OBJECTDIR}/src/testUnitaireCapteurs.o: src/testUnitaireCapteurs.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/testUnitaireCapteurs.o src/testUnitaireCapteurs.cpp

${OBJECTDIR}/src/testUnitaireClimat.o: src/testUnitaireClimat.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/testUnitaireClimat.o src/testUnitaireClimat.cpp
